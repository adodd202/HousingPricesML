...
def main():
	...
	X_train, y_train, X_predict = import_data(name_data = "andrew")
...
class Stacker():
	...
	def stack_valid_predict(self, X_stack_train_full, y_stack_train_full, X_stack_predict, output_csv = "no"):
		...
		if self.model_name != "average":
			...
			rmse = get_error(y_test_stack, y_pred_stack, type = "rmsle")
			...
			rmse = get_error(y_stack_train_full, y_pred_stack, type = "rmsle")
...
def interaction_terms(X_train, X_predict):
	...
	cols_2_combo = [[12, 8], [20, 19], [21, 12], [28, 27], [30, 29], [32, 25], [41, 21], [42, 38], [45, 44],
 					[47, 14], [51, 50], [63, 62], [65, 38], [67, 0], [68, 0], [68, 67], [69, 3], [70, 4],
 					[71, 4], [71, 70], [74, 73], [75, 7], [78, 37], [79, 11], [79, 37], [80, 16], [81, 16],
 					[81, 80], [86, 82], [87, 84], [88, 83], [89, 19], [89, 20], [90, 20], [90, 89], [91, 23],
 					[92, 23], [92, 91], [93, 26], [95, 33], [96, 36], [98, 46], [98, 97], [99, 52], [101, 63],
 					[107, 78], [112, 79]]
...
def optimize():
	...
	xgb_BO = BayesianOptimization(xgb_func, {'min_child_weight': (1, 4),
...
def lasso_func(alpha):
	...
	X_train_inter, _ = interaction_terms(X_train, X_predict)
	X_train = np.concatenate((X_train, X_train_inter), axis = 1)
